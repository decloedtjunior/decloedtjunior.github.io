...
permalink: /reactive-manifesto/
---
_Published on September 16 2014. (v2.0)_
...
Systems built as Reactive Systems are more flexible, loosely-coupled and [scalable](/glossary/#scalability). This makes them easier to develop and amenable to change. They are significantly more tolerant of failure and when [failure](/glossary/#failure) does occur they meet it with elegance rather than disaster. Reactive Systems are highly responsive, giving users effective interactive feedback.
...
_Credits and more info to [www.reactivemanifesto.org](http://www.reactivemanifesto.org/)_