...
Get the server version: [`docker version`](https://docs.docker.com/engine/reference/commandline/version/) shows which version of docker you have running.
...
Credits and more info at [this link](https://github.com/wsargent/docker-cheat-sheet/)
